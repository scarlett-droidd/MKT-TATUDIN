        ...
        tools: [
            {
                ...
                description: "Crea contenido viral con storytelling para redes sociales. Aplica fórmulas como Así que–Para qué, Efecto Manzana o Método Hilos según la plataforma y objetivo.",
                inputSchema: {
                    type: "object",
                    properties: {
                        idea: {
                        ...
                        formula: {
                            ...
                            description: "Fórmula de storytelling a usar. 'auto' elige la más adecuada.",
                            default: "auto",
                        },
                        tono: {
                            type: "string",
            ...
            {
                name: "generar_hook",
                description: "Genera hooks virales de apertura para captar atención en los primeros 3 segundos según la plataforma.",
                inputSchema: {
                    type: "object",
                    properties: {
                        tema: {
            ...
            },
            {
                ...
                description: "Analiza contenido existente y sugiere mejoras usando las fórmulas de storytelling viral.",
                inputSchema: {
                    type: "object",
                    properties: {
                        contenido: {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    if (name === "crear_contenido") {
        const { idea, plataforma, formato, formula = "auto", tono = "inspiracional" } = args;
...
Responde directamente con el contenido, sin explicaciones previas.`;
    ...
    if (name === "generar_hook") {
        const { tema, plataforma, cantidad = 3 } = args;
        const prompt = `${SKILL_MD}
...
Sin explicaciones adicionales.`;
    ...
    if (name === "analizar_contenido") {
        const { contenido, plataforma = "general" } = args;
        const prompt = `${SKILL_MD}
